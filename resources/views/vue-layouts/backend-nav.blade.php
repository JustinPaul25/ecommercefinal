    ...
    <div id="nav-sub-menu" class="hidden px-2 pt-2 pb-3 space-y-1 sm:px-3">
        ...
        @if(auth()->user())
            ...
            @else
                ...
                <a href="{{ route('admin-messages') }}" href="#" class="text-white hover:bg-orange-500 hover:bg-opacity-75 block px-3 py-2 rounded-md text-base font-medium">Quiries</a>
            @endif
        @else
    ...
    @if(auth()->user())
        <div class="pt-4 pb-3 border-t border-orange-700">
            ...
            <div id="mobile-menu" class="hidden mt-3 px-2 space-y-1">
                <a href="{{ route('messages') }}" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-orange-500 hover:bg-opacity-75">Messages</a>

                <a href="{{ route('cart') }}" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-orange-500 hover:bg-opacity-75">My Cart</a>
