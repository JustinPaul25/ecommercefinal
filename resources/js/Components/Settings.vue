            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input :disabled="!isEdit" v-model="form.city" name="city" type="text" autocomplete="city" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm">
                        </div>
                    </div>
                    <div>
                        <label for="brgy" class="block text-sm font-medium text-gray-700"> Barangay </label>
                        <div class="mt-1">
                            <input :disabled="!isEdit" v-model="form.brgy" name="brgy" type="text" autocomplete="brgy" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm">
                        </div>
                    </div>
                    <div>
