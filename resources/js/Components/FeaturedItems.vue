    ...
    <div v-if="hotDeals.length != 0" class="px-12">
        ...
        <div class="bg-orange-200">
            <div class="max-w-2xl mx-auto py-4 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <a href="/products/hot-deals" class="whitespace-nowrap text-sm font-medium text-indigo-600 hover:text-indigo-500">View all<span aria-hidden="true"> &rarr;</span></a>
                </div>
                <div class="mt-6 grid grid-cols-1 gap-x-8 gap-y-8 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                    <div v-for="hotdeal in hotDeals" :key="hotdeal" class="relative group">
